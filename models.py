...
class ThoughtData(BaseModel):
    ...
    revises_thought: Optional[int] = Field(None, ge=1, description="Thought number being revised")
    branch_from: Optional[int] = Field(None, ge=1, description="Thought number to branch from")
    branch_id: Optional[str] = Field(None, description="Unique branch identifier")
    needs_more: bool = Field(False, description="Whether more thoughts are needed beyond estimate")
